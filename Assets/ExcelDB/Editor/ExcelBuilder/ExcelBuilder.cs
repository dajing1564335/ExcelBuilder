...
public class ExcelBuilder
{
    ...
    public static string TableFolder = Application.dataPath + "/ExcelDB/Generate/Table/";
    public static string RefFolder = Application.dataPath + "/ExcelDB/Generate/Ref/";
    ...
    private static string GetTableName(string name, string fileName)
    {
